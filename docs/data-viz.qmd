...
delta_visits_raw <- read_csv(url("https://portal.edirepository.org/nis/dataviewer?packageid=edi.587.1&entityid=cda8c1384af0089b506d51ad8507641f"))
...
## Plotting with `ggplot()` in the ggplot2 package
```{r}
...
ggplot(daily_visits_loc,
  ...
  scale_y_continuous(breaks = seq(0,120,20)) + # manually scale the y axis from 0-120 with ticks at intervals of 20
  scale_fill_viridis_d() + # color palette from viridis package
  scale_fill_discrete()
